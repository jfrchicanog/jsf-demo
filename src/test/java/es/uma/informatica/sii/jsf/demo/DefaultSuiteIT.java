...
public class DefaultSuiteIT {	
	...
	public static void setupClass() {
		...
		try (InputStream is = DefaultSuiteIT.class.getClassLoader().getResourceAsStream("pom.properties")) {
		...
		baseURL="http://"+server+":8080/jsf.demo/";
	}
	...
	public void apellidopresenteentabla() {
		...
		driver.get(baseURL+"faces/agenda.xhtml");
